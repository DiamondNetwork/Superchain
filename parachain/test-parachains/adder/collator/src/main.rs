...
use diamond_cli::{Error, Result};
use diamond_node_primitives::CollationGenerationConfig;
use diamond_node_subsystem::messages::{CollationGenerationMessage, CollatorProtocolMessage};
use diamond_primitives::v1::Id as ParaId;
			...
			runner.run_node_until_exit(|config| async move {
				...
				match role {
					...
					_ => {
						...
						let full_node = diamond_service::build_full(
							config,
							diamond_service::IsCollator::Yes(collator.collator_key()),
							None,
							true,
							None,
							None,
