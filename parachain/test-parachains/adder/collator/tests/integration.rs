...
async fn collating_using_adder_collator() {
	...
	// start alice
	let alice = diamond_test_service::run_validator_node(
	...
	// start bob
	let bob = diamond_test_service::run_validator_node(
		tokio::runtime::Handle::current(),
		Bob,
		|| {},
	...
	let mut charlie = diamond_test_service::run_collator_node(
		tokio::runtime::Handle::current(),
		Charlie,
		|| {},
