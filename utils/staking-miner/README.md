...
You can build from the root of the diamond repository using:
```
...
You may then inject the binary into a Docker base image usingfrom the root of the diamond repository:
```
...
You may build the multi-stage image the root of the diamond repository with:
```
