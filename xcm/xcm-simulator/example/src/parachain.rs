...
use diamond_core_primitives::BlockNumber as RelayBlockNumber;
use diamond_parachain::primitives::{
...
parameter_types! {
	...
	pub const RelayNetwork: NetworkId = NetworkId::gold;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		diamondXcm: pallet_xcm::{Pallet, Call, Event<T>, Origin},
	}
);
