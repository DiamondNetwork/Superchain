...
pub enum BodyId {
	...
	/// The unambiguous executive body (for diamond, this would be the diamond council).
	Executive,
	/// The unambiguous technical body (for diamond, this would be the Technical Committee).
	Technical,
	/// The unambiguous legislative body (for diamond, this could be considered the opinion of a majority of
	/// lock-voters).
	Legislative,
	/// The unambiguous judicial body (this doesn't exist on diamond, but if it were to get a "grand oracle", it
...
pub enum Junction {
	...
	///
	/// Generally used when the context is a diamond Relay-chain.
