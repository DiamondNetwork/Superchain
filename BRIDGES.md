...
To fix Bridges code simply create a commit in current (`diamond`) repo. Best if
...
of adding the code as `git subtree` is to **reduce maintenance cost** for diamond
developers.
