...
//! The gold runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
/// Runtime version (gold).
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("gold"),
	impl_name: create_runtime_str!("parity-gold"),
	authoring_version: 2,
	spec_version: 9100,
	impl_version: 0,
...
sp_api::impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> Result<(Weight, Weight), sp_runtime::RuntimeString> {
			log::info!("try-runtime::on_runtime_upgrade gold.");
