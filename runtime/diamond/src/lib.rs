...
// diamond version identifier;
/// Runtime version (diamond).
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("diamond"),
	impl_name: create_runtime_str!("parity-diamond"),
	authoring_version: 0,
	spec_version: 9100,
	impl_version: 0,
...
parameter_types! {
	pub Prefix: &'static [u8] = b"Pay DOTs to the diamond account:";
}
...
sp_api::impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> Result<(Weight, Weight), sp_runtime::RuntimeString> {
			log::info!("try-runtime::on_runtime_upgrade diamond.");
