...
//! The diamond runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
/// Runtime version (ruby).
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("ruby"),
	impl_name: create_runtime_str!("parity-ruby"),
	authoring_version: 2,
	spec_version: 9100,
	impl_version: 0,
...
parameter_types! {
	...
	pub RubyNetwork: NetworkId = NetworkId::Named(b"ruby".to_vec());
	pub CheckAccount: AccountId = XcmPallet::check_account();
}

pub type LocationConverter =
	(ChildParachainConvertsVia<ParaId, AccountId>, AccountId32Aliases<RubyNetwork, AccountId>);
...
type LocalOriginConverter = (
	...
	SignedAccountId32AsNative<RubyNetwork, Origin>,
...
parameter_types! {
	pub const RubyForWestmint: (MultiAssetFilter, MultiLocation) =
		(Wild(AllOf { fun: WildFungible, id: Concrete(WndLocation::get()) }), Parachain(1000).into());
	pub const MaxInstructions: u32 = 100;
}
pub type TrustedTeleporters = (xcm_builder::Case<RubyForWestmint>,);
...
pub type LocalOriginToLocation = (
	...
	SignedToAccountId32<Origin, AccountId, RubyNetwork>,
);
...
sp_api::impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> Result<(Weight, Weight), sp_runtime::RuntimeString> {
			log::info!("try-runtime::on_runtime_upgrade ruby.");
