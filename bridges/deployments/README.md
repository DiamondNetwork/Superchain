...
Use [wss://rialto.bridges.test-installations.parity.io/](https://diamond.js.org/apps/)
as a custom endpoint for [https://diamond.js.org/apps/](https://diamond.js.org/apps/).
