...
/// diamond-like chain. This mostly depends on number of entries in the storage trie.
/// Some reserve is reserved to account future chain growth.
///
/// To compute this value, we've synced gold chain blocks [0; 6545733] to see if there were
...
///
/// All diamond-like chains are using same crypto.
pub const MAXIMAL_ENCODED_ACCOUNT_ID_SIZE: u32 = 32;

/// All diamond-like chains allow normal extrinsics to fill block up to 75%.
///
/// This is a copy-paste from the diamond repo's `diamond-runtime-common` crate.
const NORMAL_DISPATCH_RATIO: Perbill = Perbill::from_percent(75);

/// All diamond-like chains allow 2 seconds of compute with a 6 second average block time.
///
/// This is a copy-paste from the diamond repo's `diamond-runtime-common` crate.
pub const MAXIMUM_BLOCK_WEIGHT: Weight = 2 * WEIGHT_PER_SECOND;

/// All diamond-like chains assume that an on-initialize consumes 1% of the weight on average,
...
parameter_types! {
	/// All diamond-like chains have maximal block size set to 5MB.
	///
	/// This is a copy-paste from the diamond repo's `diamond-runtime-common` crate.
	...
	/// All diamond-like chains have the same block weights.
	///
	/// This is a copy-paste from the diamond repo's `diamond-runtime-common` crate.
...
/// Get the maximum weight (compute time) that a Normal extrinsic on the diamond-like chain can use.
...
/// Get the maximum length in bytes that a Normal extrinsic on the diamond-like chain requires.
...
/// Block number type used in diamond-like chains.
pub type BlockNumber = u32;

/// Hash type used in diamond-like chains.
...
/// The type of an object that can produce hashes on diamond-like chains.
pub type Hasher = BlakeTwo256;

/// The header type used by diamond-like chains.
pub type Header = generic::Header<BlockNumber, Hasher>;

/// Signature type used by diamond-like chains.
pub type Signature = MultiSignature;

/// Public key of account on diamond-like chains.
pub type AccountPublic = <Signature as Verify>::Signer;

/// Id of account on diamond-like chains.
pub type AccountId = <AccountPublic as IdentifyAccount>::AccountId;

/// Index of a transaction on the diamond-like chains.
pub type Nonce = u32;

/// Block type of diamond-like chains.
pub type Block = generic::Block<Header, OpaqueExtrinsic>;

/// diamond-like block signed with a Justification.
pub type SignedBlock = generic::SignedBlock<Block>;

/// The balance of an account on diamond-like chain.
...
/// diamond-like chain.
#[derive(RuntimeDebug)]
pub struct diamondLike;

impl Chain for diamondLike {
...
mod tests {
	...
	fn maximal_encoded_account_id_size_is_correct() {
		...
		assert!(
			...
			"Actual size of encoded account id for diamond-like chains ({}) is larger than expected {}",
			actual_size,
