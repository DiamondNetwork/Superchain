...
server like, for example, Discord. Most discussions around diamond and Substrate happen
in various Element "rooms" (channels). So, joining Element might be a good idea, anyway.

If you are interested in information exchange and development of diamond related bridges please
feel free to join the [diamond Bridges](https://app.element.io/#/room/#bridges:web3.foundation)
Element channel.
