...
These data types are defined in `diamond/primitives/src/v1.rs`:
...
digraph {
    ...
    Id [label="diamond_parachain::primitives::Id"]
    CollatorId [label="diamond_primitives::v0::CollatorId"]
    ...
    TransientValidationData:balance -> "diamond_core_primitives::v1::Balance":w
    ...
    CandidateCommitments:upward_messages -> "diamond_parachain::primitives::UpwardMessage":w
    CandidateCommitments:horizontal_messages -> "diamond_core_primitives::v1::OutboundHrmpMessage":w
    CandidateCommitments:head_data -> HeadData:w
    CandidateCommitments:horizontal_messages -> "diamond_parachain::primitives::Id":w
    CandidateCommitments:new_validation_code -> "diamond_parachain::primitives::ValidationCode":w
    ...
    PoV:block_data -> "diamond_parachain::primitives::BlockData":w
    ...
    BackedCandidate:validity_votes  -> "diamond_primitives:v0:ValidityAttestation":w

    HeadData [label = "diamond_parachain::primitives::HeadData"]
    ...
    ValidatorId [label = "diamond_primitives::v0::ValidatorId"]
    AuthorityDiscoveryId [label = "sp_authority_discovery::AuthorityId"]
    ValidatorIndex [label = "diamond_primitives::v0::ValidatorIndex"]
...
These data types are defined in `diamond/parachain/src/primitives.rs`:
...
digraph {
    ...
    RelayChainBlockNumber [label = "diamond_core_primitives::BlockNumber"]
    ...
    OutboundHrmpMessage [label = "diamond_core_primitives::OutboundHrmpMessage"]
}
```
