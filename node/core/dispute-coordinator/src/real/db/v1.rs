...
use diamond_node_subsystem::{SubsystemError, SubsystemResult};
...
impl From<CandidateVotes> for diamond_node_primitives::CandidateVotes {
	fn from(db_votes: CandidateVotes) -> diamond_node_primitives::CandidateVotes {
		diamond_node_primitives::CandidateVotes {
...
impl From<diamond_node_primitives::CandidateVotes> for CandidateVotes {
	fn from(primitive_votes: diamond_node_primitives::CandidateVotes) -> CandidateVotes {
		CandidateVotes {
...
mod tests {
	use super::*;
	use diamond_primitives::v1::{Hash, Id as ParaId};
