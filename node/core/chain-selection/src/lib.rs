...
use diamond_node_primitives::BlockWeight;
use diamond_node_subsystem::{
	errors::ChainApiError,
	messages::{ChainApiMessage, ChainSelectionMessage},
	overseer, FromOverseer, OverseerSignal, SpawnedSubsystem, SubsystemContext, SubsystemError,
};
use diamond_primitives::v1::{BlockNumber, ConsensusLog, Hash, Header};
...
async fn handle_active_leaf(
	...
	let new_blocks = diamond_node_subsystem_util::determine_new_blocks(
		ctx.sender(),
