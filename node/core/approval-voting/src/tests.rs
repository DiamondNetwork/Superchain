...
use diamond_node_subsystem_test_helpers as test_helpers;
use diamond_node_subsystem_util::TimeoutExt;
use diamond_overseer::HeadSupportsParachains;
...
where
	Compute: Fn() -> HashMap<diamond_primitives::v1::CoreIndex, criteria::OurAssignment>,
...
impl<F>
	MockAssignmentCriteria<
		fn() -> HashMap<diamond_primitives::v1::CoreIndex, criteria::OurAssignment>,
		F,
	>
{
...
fn test_harness<T: Future<Output = VirtualOverseer>>(
	...
	let _ = keystore.sr25519_generate_new(
		diamond_primitives::v1::PARACHAIN_KEY_TYPE_ID,
