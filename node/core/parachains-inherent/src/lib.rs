...
use diamond_primitives::v1::{Block, Hash, InherentData as ParachainsInherentData};
...
impl sp_inherents::InherentDataProvider for ParachainsInherentDataProvider {
	fn provide_inherent_data(
		...
		inherent_data
			.put_data(diamond_primitives::v1::PARACHAINS_INHERENT_IDENTIFIER, &self.inherent_data)
	}
