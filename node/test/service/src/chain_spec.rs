...
use diamond_primitives::v1::{AccountId, AssignmentId, ValidatorId, MAX_CODE_SIZE, MAX_POV_SIZE};
use diamond_service::chain_spec::{get_account_id_from_seed, get_from_seed, Extensions};
use diamond_test_runtime::{constants::currency::DOTS, BABE_GENESIS_EPOCH_CONFIG};
...
pub fn diamond_local_testnet_genesis() -> diamond_test_runtime::GenesisConfig {
...
fn diamond_testnet_genesis(
...
) -> diamond_test_runtime::GenesisConfig {
	use diamond_test_runtime as runtime;
	...
	runtime::GenesisConfig {
		...
		configuration: runtime::ConfigurationConfig {
			config: diamond_runtime_parachains::configuration::HostConfiguration {
