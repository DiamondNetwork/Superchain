...
//! Binary used for Simnet nodes, supports all runtimes, although only diamond is implemented currently.
//! This binary accepts all the CLI args the diamond binary does, Only difference is it uses
