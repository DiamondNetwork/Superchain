...
use diamond_node_network_protocol::{authority_discovery::AuthorityDiscovery, PeerId};
use sc_keystore::LocalKeystore;
use sp_application_crypto::AppKey;
use sp_keyring::Sr25519Keyring;
use sp_keystore::{SyncCryptoStore, SyncCryptoStorePtr};

use diamond_node_primitives::{DisputeMessage, SignedDisputeStatement};
...
impl AuthorityDiscovery for MockAuthorityDiscovery {
	async fn get_addresses_by_authority_id(
		&mut self,
		_authority: diamond_primitives::v1::AuthorityDiscoveryId,
	...
	async fn get_authority_id_by_peer_id(
		&mut self,
		peer_id: diamond_node_network_protocol::PeerId,
	) -> Option<diamond_primitives::v1::AuthorityDiscoveryId> {
