...
use diamond_node_primitives::{SignedFullStatement, Statement, UncheckedSignedFullStatement};
...
struct PeerRelayParentKnowledge {
	...
	/// `https://github.com/paritytech/diamond/issues/2979` implemented also no longer necessary.
