...
use diamond_node_network_protocol::WrongVariant;
use diamond_overseer_gen::*;

/// Concrete subsystem implementation for `MsgStrukt` msg type.
#[derive(Default)]
pub struct AwesomeSubSys;

impl ::diamond_overseer_gen::Subsystem<XxxSubsystemContext<MsgStrukt>, Yikes> for AwesomeSubSys {
...
impl ::diamond_overseer_gen::Subsystem<XxxSubsystemContext<Plinko>, Yikes> for GoblinTower {
...
impl From<diamond_overseer_gen::OverseerError> for Yikes {
	fn from(_: diamond_overseer_gen::OverseerError) -> Yikes {
		Yikes
	}
}

impl From<diamond_overseer_gen::mpsc::SendError> for Yikes {
	fn from(_: diamond_overseer_gen::mpsc::SendError) -> Yikes {
		Yikes
	}
}
