...
//!
//! Unlike the `diamond-primitives` crate, these primitives are only used on the node-side,
...
pub use diamond_parachain::primitives::BlockData;
...
/// On diamond this is 1 day, and on gold it's 6 hours.
///
...
///
/// - does not contain the erasure root; that's computed at the diamond level, not at Cumulus
/// - contains a proof of validity.
#[derive(Clone, Encode, Decode)]
pub struct Collation<BlockNumber = diamond_primitives::v1::BlockNumber> {
